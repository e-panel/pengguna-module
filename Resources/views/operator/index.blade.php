                    ...
                    <table id="datatable" class="display table table-striped" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th>{{ __('pengguna::table.operator.name') }}</th>
                                <th>{{ __('pengguna::table.operator.username') }}</th>
                                <th>{{ __('pengguna::table.operator.password') }}</th>
                                <th class="text-right">{{ __('pengguna::table.operator.last_login') }}</th>
                                <th></th>
                            </tr>
                        </thead>
                    </table>
